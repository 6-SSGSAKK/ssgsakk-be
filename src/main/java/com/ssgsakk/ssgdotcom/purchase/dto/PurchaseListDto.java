...
public class PurchaseListDto {
    ...
    public PurchaseListDto(Long purchaseSeq, String purchaser, String purchaseCode, String purchaseuuid,
                           String purchaserPhoneNum, String purchaseEmail, String recipient, String recipientPhoneNum,
                           String recipientEmail, String purchaseZipcode, String purchaseRoadAddress, String purchaseJibunAddress,
                           String purchaseDetailAddress, String deliverymessage, Long shippingFee) {
