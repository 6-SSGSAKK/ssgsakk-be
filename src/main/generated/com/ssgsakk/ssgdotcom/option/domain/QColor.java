...
public class QColor extends EntityPathBase<Color> {
    ...
    private static final long serialVersionUID = 619133501L;

    public static final QColor color = new QColor("color");

    public final StringPath colorData = createString("colorData");

    public final NumberPath<Long> colorSeq = createNumber("colorSeq", Long.class);
